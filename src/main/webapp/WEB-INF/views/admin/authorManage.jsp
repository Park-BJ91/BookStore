...
<body>
				...
				<!-- 전달받은 '작가 목록' 데이터("list")를 활용하여 게시판 표의 형태로 출력시키고자 합니다 -->
                    	...
                    	<form id="searchForm" action="/admin/authorManage" method="get">
                    		<div class="search_input">
                    			...
                    			<button class='btn search_btn'>검 색</button>
                                        ...
                                        <!-- 페이지 이동 인터페이스 영역  참조 https://kimvampa.tistory.com/185-->
...
<fomr> 태그 속성에 설정되어 있는 url 경로와 method 방식으로 form을 서버로 전송합니다. */
