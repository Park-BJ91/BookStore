...
<body>
                ...
                <div class="admin_content_wrap">
                    <div class="admin_content_subject"><span>상품 조회</span></div>
...
$(document).ready(function(){
	...
	/* 새롭게 생성 초기화한 변수를 활용하여 '할인율' <input> 태그란에 삽입해주는 코드를 추가 */		
	...
	/* targetCate3 변수는 오로지 코드로만 되어있음 cateParent, cateName 값도 포함된 객체를 저장되도록 아래의 코드를 추가 */
